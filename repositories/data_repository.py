...
class DataRepository:
    def __init__(self, db_path='./data/financial_control.db'):
        ...
        #self._populate_database_if_empty()  # Chama o método para verificar e popular o banco
    ...
    def _initialize_database(self):
        ...
        try:
            with sqlite3.connect(self.db_path) as conn:
                ...
                #tenant_id (adicionar mais tarde para multi-tenant).
                sql_user = '''
...
#Pagamento
    ...
    #Teste
    def get_connection():#usando no user_repositpry.py
    ...
    def _is_database_empty(self):
        """
        Verifica se o banco de dados está vazio (usando a tabela 'categories' como referência).
        """
        with sqlite3.connect(self.db_path) as conn:
            cursor = conn.cursor()
            cursor.execute("SELECT COUNT(*) FROM category;")  # Altere a tabela se necessário
            result = cursor.fetchone()
            return result[0] == 0  # Retorna True se estiver vazio
